...
parser.add_argument('--weights', default=None, type=str,
                    metavar='WEIGHTS', help='trained model file')
...
save_dir = "models/{}/VOC0712/{}_score".format(model_prefix, job_name)
...
job_dir = "jobs/{}/VOC0712/{}_score".format(model_prefix,job_name)
